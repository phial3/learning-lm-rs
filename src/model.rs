    ...
    for h in 0..n_q_h {
        for row in 0..seq_len {
            for col in 0..total_seq_len {
                ...
                att_data[row * att_dim + h * total_seq_len + col] = (0..dqkv)
    ...
    for h in 0..n_q_h {
        for row in 0..seq_len {
            for col in 0..dqkv {
                ...
                hidden_data[row * q_dim + h * dqkv + col] = (0..total_seq_len)
                    .map(|d| att[a_base + d] * v_data[v_base + d])
                    .sum::<f32>();
            }
        }
    }
